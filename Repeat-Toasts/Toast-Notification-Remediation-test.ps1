...
$ToastTimes = @("10:20", "10:30", "10:45")

#Toast Message
$ToastTitle = "Testing Scheduled Notifications"
$ToastText = "This is a test of using Proactive Remediations to display Toast Notifications. Please feel free to ignore this message and dismiss it."
