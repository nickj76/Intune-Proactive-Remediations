...
$Toast_Button2_Text = "Show Detailed Report" # Text to display in the second button
$Toast_Button1_Explanation_Text = "Click on «$Toast_Button1_Text» to understand how to save space on your disk."
$Toast_Button2_Explanation_Text = "Click Show Report to list which folder(s) and file(s) take a lot of space on your disk."
